...
import com.demo.author.repository.AuthorRepository;
import com.demo.author.service.dto.AuthorDTO;
import com.demo.author.service.mapper.AuthorMapper;
...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).handle(DEFAULT_HANDLE);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).handle(UPDATED_HANDLE);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getHandle()).isEqualTo(DEFAULT_HANDLE);
    }
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).handle(UPDATED_HANDLE);
        ...
        assertThat(testAuthor.getHandle()).isEqualTo(UPDATED_HANDLE);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.handle(UPDATED_HANDLE);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).handle(UPDATED_HANDLE);
