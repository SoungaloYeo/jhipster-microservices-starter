...
import com.demo.author.service.AuthorService;
import com.demo.author.service.dto.AuthorDTO;
import com.demo.author.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.demo.author.domain.Author}.
 */
@RestController
@RequestMapping("/api")
public class AuthorResource {
    ...
    private static final String ENTITY_NAME = "authorAuthor";
